...
public class FlipkartProject {
	...
	public void mouseHover() {
		...
		WaitUtils.waitTillElementVisible(driver, 10, By.xpath("//div[@class='xtXmba'][text()='Electronics']"));
		
		//WaitUtils.waitTillElementVisibleWithFluentWait(driver, 500, 10, By.xpath("//div[@class='xtXmba'][text()='Electronics']"));
